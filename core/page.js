module.exports = {
    currentPage: null,
    currentPageOptions: {},
  navbarPages: ["pages/index/index", "pages/audition/audition", "pages/cart/cart", "pages/user/user", "pages/list/list", "pages/search/search", "pages/topic-list/topic-list", "pages/video/video-list", "pages/miaosha/miaosha", "pages/shop/shop", "pages/pt/index/index", "pages/book/index/index", "pages/share/index", "pages/quick-purchase/index/index", "mch/m/myshop/myshop", "mch/shop-list/shop-list", "pages/integral-mall/index/index", "pages/integral-mall/register/index", "pages/article-detail/article-detail", "pages/article-list/article-list", "pages/order/order",'pages/recruit/recruit-hall' ],
    onLoad: function(t, e) {
        ...
        t.request({
            ...
            success: function(e) {
                0 == e.code && (t.core.setStorageSync(getApp().const.NAVIGATION_BAR_COLOR, e.data), 
                  o.setNavigationBarColor(e.data.status.audit_status), t.navigateBarColorCall && "function" == typeof t.navigateBarColorCall && t.navigateBarColorCall(e)); 
            }
        });
    },
  setNavigationBarColor: function (message) {
