...
var api = {
  ...
  task: {
    find_task: _api_root + "task/find-task",
    complete_task: _api_root + "task/complete-task",
  },
  consultantation: {
    consultantation_list: _api_root + "consultantation/yy-zx-index/index",
    consultants_details: _api_root + "consultantation/yy-zx-index/consultants-details",
    consultants_time: _api_root + "consultantation/yy-zx-index/consultants-time",
    consultants_submit: _api_root + "consultantation/yy-zx-order/submit",
    consultants_order: _api_root + "consultantation/yy-zx-user/order",
    order_confirm: _api_root + "consultantation/yy-zx-order/confirm",
    start_consulting: _api_root + "consultantation/yy-zx-order/start-consulting",
    user_upgrade: _api_root + "consultantation/yy-zx-user/upgrade",
    apply_consultancy: _api_root + "consultantation/yy-zx-user/apply-consultancy", 
    index: _api_root + "consultantation/yy-zx-user/index",
    tag_list: _api_root + "consultantation/yy-zx-user/tag-list",
    user_edit: _api_root + "consultantation/yy-zx-user/user-edit",  
    order_details: _api_root + "consultantation/yy-zx-user/order-details",  
    order_list: _api_root + "consultantation/yy-zx-user/order-list",  
    sms_code: _api_root + "consultantation/yy-zx-user/sms-code",  
    cancel: _api_root + "consultantation/yy-zx-order/cancel",  
    consultants_comment: _api_root + "consultantation/yy-zx-index/consultants-comment",  
    comment: _api_root + "consultantation/yy-zx-order/comment",  
  },

  audiovisual:{
    audio_subcategory: _api_root + "audiovisual/article/subcategory",
    audio_category: _api_root + "audiovisual/article/category",
    audio_catalog: _api_root + "audiovisual/article/catalog",
    audio_details: _api_root + "audiovisual/article/article-details", 
    category: _api_root + "audiovisual/activity-show/category", 
    catalog: _api_root + "audiovisual/activity-show/catalog", 
    article_details: _api_root + "audiovisual/activity-show/article-details", 
    collect_comments: _api_root + "audiovisual/comment/collect-comments",
    comment_list: _api_root + "audiovisual/comment/comment-list",
    heart_index: _api_root + "audiovisual/warm-heart/index",
    article_details: _api_root + "audiovisual/warm-heart/article-details",
    // 增加收藏
    collect_collect: _api_root + "audiovisual/collect/collect",
    // 取消收藏
    cancel_collection: _api_root + "audiovisual/collect/cancel-collection",
    index: _api_root + "audiovisual/index/index",
    cinema_category: _api_root + "audiovisual/cinema/category",
    // 上一章
    previous_article: _api_root +'audiovisual/article/previous-article',
    // 下一章
    next_article: _api_root + 'audiovisual/article/next-article',
  },
  ...
  default: {
    ...
    room:{
      getUserInfo: _api_root +'consultantation/yy-zx-order/status'
    }
};
